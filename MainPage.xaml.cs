namespace App326
{
  ...
  public sealed partial class MainPage : Page, INotifyPropertyChanged
  {
    ...
    async Task CaptureVoiceAsync(int timeInSeconds, bool firstTime)
    {
      ...
      this.recordingFile = await ApplicationData.Current.TemporaryFolder.CreateFileAsync(
        RECORDING_FILE,
        CreationCollisionOption.ReplaceExisting);

      //await this.DisplayAndSay("please start reading");
    ...
    static readonly int REQUIRED_SPEECH_TIME = 60;
    static readonly int MINIMUM_SPEECH_TIME = 20;
    static readonly string RECORDING_FILE = "recording.bin";
    static readonly string READ_URL =
      "http://downloads.bbc.co.uk/writersroom/scripts/DM-S1-E38-39-The-Snowman-Cometh-Shooting-Script.pdf";
